<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="Руководства Neural DSP на русском языке: полные PDF с иллюстрациями, навигацией и поиском">
</p>
...
| Плагин | Archetype: Gojira X | [1.0.0](https://downloads.neuraldsp.com/file/archetype-gojira-x/Archetype%20Gojira%20X%20v1.0.0.pdf) | 27.07.2026 | Опубликовано | [Открыть](https://github.com/ialexbond/neuraldsp-manuals-ru/releases/tag/archetype-gojira-x-v1.0.0-ru.2026-07-27) |
...
## Руководство Archetype: Misha Mansoor X

Русская инструкция к плагину Neural DSP Archetype: Misha Mansoor X 1.0.0 охватывает Special FX, Pre Effects, усилители, Cab, EQ и Post Effects, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.

Если вам нужно полное руководство пользователя или мануал Neural DSP Archetype: Misha Mansoor X на русском языке:

**[Открыть актуальный релиз Archetype: Misha Mansoor X →](https://github.com/ialexbond/neuraldsp-manuals-ru/releases/tag/archetype-misha-mansoor-x-v1.0.0-ru.2026-07-25)**

## Руководство Morgan Amps Suite

Русская инструкция к плагину Neural DSP Morgan Amps Suite 1.1.0 охватывает Pre FX, усилители, Cab, EQ и Post FX, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.
...
## Руководство Archetype: Tim Henson X

Русская инструкция к плагину Neural DSP Archetype: Tim Henson X 1.0.0 охватывает Pre Effects, усилители, Cab, Multivoicer, EQ и Post Effects, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.
...
## Руководство Archetype: Gojira X

Русская инструкция к плагину Neural DSP Archetype: Gojira X 1.0.0 охватывает Pitch, Pre FX, усилители, Cab, EQ и Post FX, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.

Если вам нужно полное руководство пользователя или мануал Neural DSP Archetype: Gojira X на русском языке:

**[Открыть актуальный релиз Archetype: Gojira X →](https://github.com/ialexbond/neuraldsp-manuals-ru/releases/tag/archetype-gojira-x-v1.0.0-ru.2026-07-27)**

## Руководство Archetype: Plini X

Русская инструкция к плагину Neural DSP Archetype: Plini X 1.0.0 охватывает Pre FX, усилители, Cab, EQ и Post FX, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.

Если вам нужно полное руководство пользователя или мануал Neural DSP Archetype: Plini X на русском языке:

**[Открыть актуальный релиз Archetype: Plini X →](https://github.com/ialexbond/neuraldsp-manuals-ru/releases/tag/archetype-plini-x-v1.0.0-ru.2026-07-27)**

## Руководство Archetype: Petrucci X

Русская инструкция к плагину Neural DSP Archetype: Petrucci X 1.0.0 охватывает Wah и Compressor, Pre FX, усилители, Cab, EQ, Volume и Post FX, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.

Если вам нужно полное руководство пользователя или мануал Neural DSP Archetype: Petrucci X на русском языке:

**[Открыть актуальный релиз Archetype: Petrucci X →](https://github.com/ialexbond/neuraldsp-manuals-ru/releases/tag/archetype-petrucci-x-v1.0.0-ru.2026-07-27)**

## Руководство Fortin Nameless Suite X

Русская инструкция к плагину Neural DSP Fortin Nameless Suite X 1.0.0 охватывает педали Zuul, Hexdrive и Grind, усилитель Fortin Nameless, Cab, EQ и эффекты Delay и Reverb, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.
...
## Руководство Archetype: Mateus Asato

Русская инструкция к плагину Neural DSP Archetype: Mateus Asato 1.1.0 охватывает Wah и Compressor, Pre FX, три усилителя, Cab, EQ и Post FX, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.
...
## Руководство Soldano SLO-100 X

Русская инструкция к плагину Neural DSP Soldano SLO-100 X 1.0.0 охватывает педали Overdrive-1 и Overdrive-2, усилитель Soldano SLO-100, Cab, EQ, Delay и Reverb, а также пресеты, тюнер, метроном, MIDI, установку, активацию лицензии и настройку плагина.
...
## Руководство Archetype: Abasi

Русская инструкция к плагину Neural DSP Archetype: Abasi 2.0.0 охватывает Stomp Effects Section, Amplifier Section, Graphic EQ, Neural DSP Cabinet Simulation, Time Effects Section, пресеты, MIDI, установку, активацию лицензии и настройку плагина.
